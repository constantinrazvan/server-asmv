...
namespace ServerAsmv.Migrations
{
    ...
    [Migration("20241103165300_phoneNumberVolunteer")]
    partial class phoneNumberVolunteer
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ServerAsmv.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedAt = new DateTime(2024, 11, 3, 16, 53, 0, 410, DateTimeKind.Utc).AddTicks(9343),
                            Email = "admin@asmv.com",
                            Firstname = "Admin",
                            Lastname = "Admin",
                            Password = "$2a$11$RQQ5EROj8t9o29aGbDdINuZWnnJ5sJejDA9Ub.xm9w7Afqw2dsfjm",
                            Role = "admin"
                        });
                });
