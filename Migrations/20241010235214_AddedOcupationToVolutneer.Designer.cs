...
namespace ServerAsmv.Migrations
{
    ...
    [Migration("20241010235214_AddedOcupationToVolutneer")]
    partial class AddedOcupationToVolutneer
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ServerAsmv.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedAt = new DateTime(2024, 10, 10, 23, 52, 14, 774, DateTimeKind.Utc).AddTicks(4336),
                            Email = "admin@asmv.com",
                            Firstname = "Admin",
                            Lastname = "Admin",
                            Password = "$2a$11$K0m5biXQqqDiPLpk93CGpu0OVX/IKb5melxEw/mk5je9W90FCGavW",
                            Role = "admin"
                        });
                });
