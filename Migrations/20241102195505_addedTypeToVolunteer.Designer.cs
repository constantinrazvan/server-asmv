...
namespace ServerAsmv.Migrations
{
    ...
    [Migration("20241102195505_addedTypeToVolunteer")]
    partial class addedTypeToVolunteer
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ServerAsmv.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedAt = new DateTime(2024, 11, 2, 19, 55, 4, 919, DateTimeKind.Utc).AddTicks(8672),
                            Email = "admin@asmv.com",
                            Firstname = "Admin",
                            Lastname = "Admin",
                            Password = "$2a$11$9dtdZzsWelFteNZIENfMf.gwvNJ8IAchczhF9hbuPyH2wm9l84pp.",
                            Role = "admin"
                        });
                });
