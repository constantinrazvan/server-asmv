...
namespace ServerAsmv.Migrations
{
    ...
    [Migration("20241005101623_UpdatedVolunteerToContainImage")]
    partial class UpdatedVolunteerToContainImage
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ServerAsmv.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedAt = new DateTime(2024, 10, 5, 10, 16, 23, 160, DateTimeKind.Utc).AddTicks(9321),
                            Email = "admin@asmv.com",
                            Firstname = "Admin",
                            Lastname = "Admin",
                            Password = "$2a$11$ctW/mno0.0kD3uAi5nM6xesYtuzjN.dkqtblbfQViZ7gv4LdTSKAu",
                            Role = "admin"
                        });
                });
