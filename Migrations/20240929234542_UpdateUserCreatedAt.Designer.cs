...
namespace ServerAsmv.Migrations
{
    ...
    [Migration("20240929234542_UpdateUserCreatedAt")]
            ...
            modelBuilder.Entity("ServerAsmv.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedAt = new DateTime(2024, 9, 29, 23, 45, 42, 799, DateTimeKind.Utc).AddTicks(8428),
                            Email = "admin@asmv.com",
                            Firstname = "Admin",
                            Lastname = "Admin",
                            Password = "$2a$11$X9wQrEDAEwpNSYS00E5/ge1sfCYckUjh9sCjTeuO0gD.2dHN5lwea",
                            Role = "admin"
                        });
                });
